...
print(a+"*"*3+"-"*12+"BIENVENIDO"+"-"*12+"*"*3+a) 

#dibujar el campo

print("="*80)
print(a*4); print(a*4); print(b); print(b)
print(a+c+ca[0]*2+" "*5+"|"*2+" "*5+ca[1]*2+" "*5+"||"+5*" "+ca[2]*2+c+a)
print(b); print(b); print(a + "="*40+a); print(b); print(b)
print(a+c+ca[3]*2+" "*5+"|"*2+" "*5+ca[4]*2+" "*5+"||"+5*" "+ca[5]*2+c+a)
print(b); print(b); print(a + "="*40+a); print(b); print(b)
print(a+c+ca[6]*2+" "*5+"|"*2+" "*5+ca[7]*2+" "*5+"||"+5*" "+ca[8]*2+c+a)
print(b); print(b); print(a*4); print(a*4)
